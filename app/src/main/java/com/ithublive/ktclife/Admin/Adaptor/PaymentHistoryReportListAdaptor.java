...
public class PaymentHistoryReportListAdaptor extends RecyclerView.Adapter<PaymentHistoryReportListAdaptor.MyViewHolder> {
    ...
    public PaymentHistoryReportListAdaptor(List<PaymentHistory> list, Context context2) {
        this.modelList = list;
            ...
            public void onClick(View view) {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, BaseUrl.paymentsHistoryUrl, new Response.Listener<String>() {
                    ...
                    protected Map<String, String> getParams() throws AuthFailureError {
                        ...
                        map.put("userid", "wd" + PaymentHistoryReport.intent_id);
